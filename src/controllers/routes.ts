...
import Momentum from './algorithms/backtests/momentum';
import Backtest from './algorithms/backtests/backtest';
import Indicators from './technical-analysis/indicators';
import Macd from './algorithms/backtests/macd';
import Rsi from './algorithms/backtests/rsi';
import Ema from './algorithms/backtests/ema';
import Bb from './algorithms/backtests/bb';
// import Tensorflow from './algorithms/ai/tensorflow';
import FlashCrash from './algorithms/backtests/flash-crash';
...
import MultiTicker from './algorithms/backtests/multi-ticker';
